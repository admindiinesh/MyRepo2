...
public class TestCase2 {
	@Parameters("browser")
	@Test
	public void flightTest(String b) throws Exception
	{
		...
		Flights flt=PageFactory.initElements(driver, Flights.class);
		wmt.flights();
		flt.findAFlaight("lingachari","bathula");
		System.out.println("TestCase2"+b);
